...
//
// Visual: 144×144 rounded slate square (matches manifest @2x dimensions and
// the existing key background color), big white centered number, small white
// clock outline glyph in the upper-left corner so the button's identity is
// preserved while the count dominates the face. Counts ≥ 100 cap to "99+".
